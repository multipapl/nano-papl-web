...
import { X, FolderOpen, Upload, Check, AlertTriangle } from "lucide-react";
                ...
                {files.length === 0 ? (
                    <>
                        ...
                        <div className="flex gap-2 mt-2">
                            <Tooltip label="Pick individual images for this batch.">
                                <button
                                    type="button"
                            ...
                            <Tooltip label="Pick a whole folder. All supported images inside it will be loaded.">
                                <button
                                    type="button"
                    ...
                    <div className="w-full h-full p-3 overflow-y-auto" onClick={(e) => e.stopPropagation()}>
                        <div className="flex items-center justify-between mb-3 px-1">
                            ...
                            <div className="flex gap-2">
                                <Tooltip label="Add more images to the current batch.">
                                    <button
                                        type="button"
                                ...
                                <Tooltip label="Remove all loaded input images from this batch.">
                                    <button
                                        type="button"
                                        onClick={clearAll}
